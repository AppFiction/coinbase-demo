    ...
    return new Promise((resolve, reject) => {
        client.getAccount('primary', function (err, account) {
            if (err) {
                switch (err.name) {
                    case "ExpiredToken":
                        res.send("Coinbase testing token has expired. Please contact developer");
...
function getAccessToken(code) {
    return new Promise((resolve, reject) => {
        const data = JSON.stringify({
            ...
            code,
            client_id: "4ae06befeedf464ecc5606a87163dc3236621360730133e690ba9c90a494ef10",
            client_secret: "4b36897a62d47cd4f82b43085acb72d271aa20c25aaf5e26104fdc9dc54b8a83",
